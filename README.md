<h1 align="center">Insight-api-zula</h1>

<div align="center">
  <strong>A Zula blockchain REST and WebSocket API Service</strong>
</div>
<br />
<div align="center">
  <!-- Stability -->
  ...
  <a href="https://npmjs.org/package/insight-api-zula">
    <img src="https://img.shields.io/npm/v/insight-api-zula.svg?style=flat-square" alt="NPM version" />
  </a>
</div>
...
```bashl
npm install -g bitcore-node-zula@latest
bitcore-node-zula create mynode
cd mynode
bitcore-node-zula install insight-api-zula
bitcore-node-zula start
```

The API endpoints will be available by default at: `http://localhost:3001/insight-api-zula/`
...
### Block
```
  /insight-api-zula/block/[:hash]
  /insight-api-zula/block/0000000006e7b38e8ab2d351239019c01de9a148b5baef58cfe52dfd9917cedc
```

### Block Index
Get block hash by height
```
  /insight-api-zula/block-index/[:height]
  /insight-api-zula/block-index/0
```
This would return:
```
{
...
### Raw Block
```
  /insight-api-zula/rawblock/[:blockHash]
```
...
```
  /insight-api-zula/blocks?limit=3&blockDate=2017-04-22
```
...
### Transaction
```
  /insight-api-zula/tx/[:txid]
  /insight-api-zula/tx/ebdca263fe1c75c8609ce8fe3d82a320a0b3ca840f4df995883f5dab1b9ff8d9
  /insight-api-zula/rawtx/[:rawid]
  /insight-api-zula/rawtx/ebdca263fe1c75c8609ce8fe3d82a320a0b3ca840f4df995883f5dab1b9ff8d9
```

### Address
```
  /insight-api-zula/addr/[:addr][?noTxList=1][&from=&to=]
  /insight-api-zula/addr/ybi3gej7Ea1MysEYLR7UMs3rMuLJH5aVsW?noTxList=1
  /insight-api-zula/addr/yPv7h2i8v3dJjfSH4L3x91JSJszjdbsJJA?from=1000&to=2000
```

### Address Properties
```
  /insight-api-zula/addr/[:addr]/balance
  /insight-api-zula/addr/[:addr]/totalReceived
  /insight-api-zula/addr/[:addr]/totalSent
  /insight-api-zula/addr/[:addr]/unconfirmedBalance
```
The response contains the value in Satoshis.

### Unspent Outputs
```
  /insight-api-zula/addr/[:addr]/utxo
```
Sample return:
```
[
...
GET method:
```
  /insight-api-zula/addrs/[:addrs]/utxo
  /insight-api-zula/addrs/ygwNQgE5f15Ygopbs2KPRYMS4TcffqBpsz,ygw5yCtVkx3hREke4L8qDqQtnNoAiPKTSx/utxo
```

POST method:
```
  /insight-api-zula/addrs/utxo
```
...
```
  /insight-api-zula/txs/?block=HASH
  /insight-api-zula/txs/?block=000000000814dd7cf470bd835334ea6624ebf0291ea857a5ab37c65592726375
```
### Transactions by Address
```
  /insight-api-zula/txs/?address=ADDR
  /insight-api-zula/txs/?address=yWFfdp9nLUjy1kJczFhRuBMUjtTkTTiyMv
```

### Transactions for Multiple Addresses
GET method:
```
  /insight-api-zula/addrs/[:addrs]/txs[?from=&to=]
  /insight-api-zula/addrs/ygwNQgE5f15Ygopbs2KPRYMS4TcffqBpsz,ygw5yCtVkx3hREke4L8qDqQtnNoAiPKTSx/txs?from=0&to=20
```

POST method:
```
  /insight-api-zula/addrs/txs
```
...
GET method:
```
  /insight-api-zula/gobject/list/proposal
```
...
GET method:
```
  /insight-api-zula/gobject/get/[:hash]
  /insight-api-zula/gobject/get/b6af3e70c686f660541a77bc035df2e5e46841020699ce3ec8fad786f7d1aa35
```
...
### Masternodes List
```
  /insight-api-zula/masternodes/list
```
### Validate Masternode
```
  /insight-api-zula/masternodes/validate/[:payee]
  /insight-api-zula/masternodes/validate/yRuALkPpeYpTgxdNn2L5YgGktASJYDYPAo
```
...
```
  /insight-api-zula/sync
```

### Live Network P2P Data Sync Status
```
  /insight-api-zula/peer
```

### Status of the Bitcoin Network
```
  /insight-api-zula/status?q=xxx
```
...
### Utility Methods
```
  /insight-api-zula/utils/estimatefee[?nbBlocks=2]
```
...
- (Medium)[How to setup a Zula Instant-Send Transaction using Insight API?????????The comprehensive way](https://medium.com/@obusco/setup-instant-send-transaction-the-comprehensive-way-a80a8a0572e)
